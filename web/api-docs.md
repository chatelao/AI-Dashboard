...
- **Endpoints:**
  - `https://api.github.com/repos/chatelao/AI-Dashboard/issues?state=all`
  - `https://api.github.com/repos/chatelao/AI-Dashboard/pulls?state=all`
  - `https://api.github.com/repos/chatelao/AI-Dashboard/commits/{sha}/check-runs`
- **Purpose:** Retrieve all issues and PR statuses for display on the dashboard.
- **Data used:** `id`, `number`, `title`, `state`, `html_url`, `assignee.login`, `pull_request`, `check_runs`.
